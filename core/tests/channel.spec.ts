import cuillere, { call, fork, Cuillere } from '../src'
import { channelMiddleware, chan, send, recv, close, range, select } from '../src/middlewares/channel'

describe('call', () => {
  let cllr: Cuillere

  beforeEach(() => {
    cllr = cuillere(channelMiddleware())
  })
